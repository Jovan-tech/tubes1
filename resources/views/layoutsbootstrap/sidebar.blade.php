      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="#" data-bs-toggle="collapse" data-bs-target="#kasMasukSubMenu" aria-expanded="false">
                    <span>
                        <i class="ti ti-alert-circle"></i>
                    </span>
                    <span class="hide-menu">Kas Masuk</span>
                </a>
                <ul class="submenu collapse" id="kasMasukSubMenu">
                    <li><a class="sidebar-link" href="penelitian">Dana Penelitian</a></li>
                    <li><a class="sidebar-link" href="pengabdian">Dana Pengabdian</a></li>
                </ul>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link" href="#" data-bs-toggle="collapse" data-bs-target="#kasKeluarSubMenu" aria-expanded="false">
                    <span>
                        <i class="ti ti-alert-circle"></i>
                    </span>
                    <span class="hide-menu">Kas Keluar</span>
                </a>
                <ul class="submenu collapse" id="kasKeluarSubMenu">
                    <li><a class="sidebar-link" href="penelitiana">Penelitian A</a></li>
                    <li><a class="sidebar-link" href="penelitianb">Penelitian B</a></li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./icon-tabler.html" aria-expanded="false">
                ...
                <span class="hide-menu">Laporan 1</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./sample-page.html" aria-expanded="false">
                ...
                <span class="hide-menu">Laporan 2</span>
              </a>
            </li>
